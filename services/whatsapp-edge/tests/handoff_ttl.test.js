...
(0, globals_1.describe)('TTL y expiración', () => {
    let tempStore;
    let sender;
    let killSwitch;
    let observability;
    ...
    (0, globals_1.it)('debe rechazar handoff expirado', async () => {
        ...
        (0, globals_1.expect)(result.message).toBe('Este enlace ha expirado. Por favor, inicia nuevamente');
        (0, globals_1.expect)(result.error_type).toBe('handoff_expired');
    });
    (0, globals_1.it)('debe aceptar handoff válido dentro de TTL', async () => {
