...
(0, globals_1.describe)('Kill-Switch bloquea outbound', () => {
    let killSwitch;
    let observability;
    let sender;
    ...
    (0, globals_1.it)('debe bloquear outbound cuando kill-switch está en modo DROP', async () => {
        ...
        (0, globals_1.expect)(result.error_type).toBe('provider_unavailable');
        // Verificar que NO se llamó a Twilio
        (0, globals_1.expect)(mockClient.messages.create).not.toHaveBeenCalled();
    });
    (0, globals_1.it)('debe bloquear outbound cuando kill-switch está en modo SILENCIO', async () => {
