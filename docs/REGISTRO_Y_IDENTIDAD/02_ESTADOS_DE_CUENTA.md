...
Estado inicial de toda cuenta después del registro. La cuenta existe pero no ha completado ninguna verificación adicional.
...
- Inicio de proceso de verificación de WhatsApp
...
El estado `operational` se alcanza automáticamente cuando se cumplen todas las condiciones:
- `whatsapp_verified`: Verificado
- `age_verified`: Verificado
- `payment_enabled`: Verificado

**Regla**: El estado `operational` no requiere verificación adicional. Es consecuencia de completar todas las verificaciones previas.
